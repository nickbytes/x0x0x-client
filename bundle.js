...
function generateLink (item, isSave) {
  ...
  if (item.description) {
    p.textContent = item.description.trim()
  } else {
    p.innerHTML = '&nbsp;'
  }
  li.appendChild(p)
...
},{"./network":3,"./notify":4,"./ws":6,"localforage":7}],2:[function(require,module,exports){
'use strict'
...
},{"./item":1,"./network":3,"./parallax.js":5,"./ws":6}],3:[function(require,module,exports){
'use strict'
...
},{"./notify":4,"./ws":6,"localforage":7}],4:[function(require,module,exports){
'use strict'
...
},{"./item":1,"./network":3,"localforage":7}],7:[function(require,module,exports){
(function (global){
/*!
